...
SCRIPT_WITH_DOWNLOADING_FUNCTIONS = os.path.join(PROJECT_ROOT, "src", "datasets", "downloading_functions.sh")
class UrlDownloader:
    ...
    def run_downloading_function(self, func_name: str, args: Optional[List[str]] = None) -> str:
        cmd = ["bash", SCRIPT_WITH_DOWNLOADING_FUNCTIONS, func_name]
        cmd.extend(args)
